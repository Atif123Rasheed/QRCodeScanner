...
import com.leeddev.qrcodescannergenerator.databinding.ActivityQrcodeScannerBinding
...
class QRCodeScanner : AppCompatActivity() {
    ...
    private var binding: ActivityQrcodeScannerBinding? = null
    ...
    fun checkSelfPermission() {
        ...
        val aniSlide: Animation = AnimationUtils.loadAnimation(this, R.anim.scanner_annimation)
        binding?.qrCodeLine?.startAnimation(aniSlide)
    }
    ...
    private fun setupControls() {
        ...
        barcodeDetector.setProcessor(object:Detector.Processor<Barcode>{
            override fun release() {
                Toast.makeText(this@QRCodeScanner,"Scanner Closed",Toast.LENGTH_SHORT).show()
            }
